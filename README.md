...
That's (Yet Another) ServiceObject pattern implementation. It was made to be fast ([benchmarks](https://github.com/ar2em1s/yaso/wiki/Benchmarks)) and simple to use (I hope). This implementation was inspired by those alternatives and hopefully it will encourage them to be even better:
